"""
Specialised for searching and recommending flights

It handles natural language queries about flight options, queries and schedules
...
def search_flights(
    ...
    if not flights:
        return "no flights found to our destination. Please check the destination name."
    ...
    results = [f"Found {len(flights)} flight(s) to your {destination}:\n"]
